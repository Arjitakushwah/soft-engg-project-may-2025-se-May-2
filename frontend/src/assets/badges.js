...
const colors = {
  ...
  const iconPaths = {
    streak: "M7.05 10.95L5.64 9.54L12 3l6.36 6.36l-1.41 1.41L12 5.83z M12 21l-6.36-6.36l1.41-1.41L12 18.17l4.95-4.95l1.41 1.41z",
    journal: "M14 2H6c-1.1 0-2 .9-2 2v16c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2V8l-6-6zm-1 9V3.5L18.5 9H13zm4 9H7v-2h10v2zm0-4H7v-2h10v2zm-3-4H7V9h7v2z",
    story: "M20 2H4c-1.1 0-2 .9-2 2v16c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2zM9 18H7v-2h2v2zm0-4H7v-2h2v2zm0-4H7V8h2v2zm11 8h-8v-2h8v2zm0-4h-8v-2h8v2zm0-4h-8V8h8v2z",
    infotainment: "M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8zm-1-13h2v2h-2V7zm0 4h2v6h-2v-6z"
  };
