...
.sidebar {
  width: 280px;
  background: linear-gradient(135deg, #ff9a8b 0%, #ff6a88 100%); /* Soft pink background */
...
.nav-btn {
  ...
  font-weight: bold;
  font-size: large;
  background-color: #ebbeb3; /* Bright pink button */
  color: rgb(40, 36, 36);
  border: none;
  cursor: pointer;
  border-radius: 10px;
...
.nav-btn:hover {
  background-color: #ff4870; /* Slightly deeper pink on hover */
}
</style>
